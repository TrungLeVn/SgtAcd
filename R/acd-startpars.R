...
acdstart = function(pars, arglist) {
  ...
  numdispar = sum(modelinc[c(11,15,19)])
  ...
  if (modelinc[11] > 0) {
    uncskew = bounds$skew
    xskew = .acdskewbounds(modelinc[11:13], uncskew, model$dmodel$model, dbounds[1:2])
  ...
  if (modelinc[15] > 0) {
    ...
    xshape1 = .acdshape1bounds(modelinc[16:18], uncshape1, model$dmodel$model, dbounds[c(3,4,7)])
  ...
  if (modelinc[19] > 0) {
      ...
      xshape2 = .acdshape2bounds(modelinc[20:22], uncshape2, model$dmodel$model, dbounds[5:7])
